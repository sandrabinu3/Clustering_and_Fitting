...
optimal_clusters = silhouette_scores.index(
    max(silhouette_scores)) + 2  # Add 2 as range started from 2
...
plt.scatter(mer_df[year+'_x'], mer_df[year+'_y'],
            c=mer_df['Cluster'], cmap='viridis')
plt.scatter(cen[:, 0], cen[:, 1], marker='d',
